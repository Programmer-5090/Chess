...
Bishop::Bishop(Color color, PieceType type, SDL_Renderer* renderer) : Piece(color, type, renderer) {
    if(color == BLACK){
        pieceImg = IMG_Load("/Users/jethroaiyesan/Programming/Chess C++/images/B_Bishop.png");
    }
    else{
        pieceImg = IMG_Load("/Users/jethroaiyesan/Programming/Chess C++/images/W_Bishop.png");
    }
